...
<body style="background-image:linear-gradient(#fffcfc,#f0f2f0,#dedede)">
    <table id="bank_transac">
        <tr>
            <td id="bankname"><font color="#134747" face="TIMES NEW ROMAN"><b>RANDOM BANK OF COUNTRY</b></font></td>
        </tr>
        <tr>
            <td>
                <div>
                    <pre id="transac_details">Merchant                           : CinePetta<br>Transaction amount          : ₹ <?php echo $_SESSION['amount']; ?><br>Debit Card                         : <?php echo $crdnum ?></pre>
        ...
        <tr>
            <td>
                ...
                <br>
                <font size="2.5">OTP sent to your mobile number ending with 00
                    <?php ?>
                </font><br><br>
